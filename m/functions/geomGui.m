...
instructs = ['Input the desired number of rows and columns and then press Create Table. '...
            'In each cell of the array, input the number associated with a given channel. '...
            'For example, for channel LAD1, you would input 1 into the table.'];
